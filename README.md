...
## 📱 Reklam Entegrasyonu
- Tüm ekranların alt kısmında `AdBanner` bileşeni üzerinden Google Mobile Ads banner reklamı gösterilir. Varsayılan olarak Google'ın test kimlikleri (`ca-app-pub-3940256099942544/6300978111` ve `ca-app-pub-3940256099942544/2934735716`) kullanılır; üretim dağıtımından önce kendi kimliklerinizle güncelleyin.
...
- `app.json` içinde `react-native-google-mobile-ads` yapılandırması iOS/Android test App ID’leri ile tanımlıdır. Kendi projenizin App ID'lerini girmeniz gerekir.
